...
public class ViewBelanjaHeader extends RelativeLayout {
    Context context;
    View rootView;
    ...
    public ViewBelanjaHeader(Context context) {
        super(context);
    ...
    private void init(final Context context) {
        rootView = inflate(context, R.layout.viewbelanjaheader, this);
    ...
    public void setData(String nofaktur, String tanggal, String unitusaha,String total,String status){
        ...
        txtNamaUnitUsaha.setText("Unit usaha");
