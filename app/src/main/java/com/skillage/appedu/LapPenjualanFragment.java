...
public class LapPenjualanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_lap_penjualan, container, false);
    }
    ...
    private class LoadingProduk extends AsyncTask<String, Integer, Integer> {
        ...
        protected void onPreExecute() {
            progressDialog.setTitle("Loading data penjualan...");
            progressDialog.show();
            super.onPreExecute();
        }

        protected Integer doInBackground(String... urls) {
            String SQL= "Select * from vw_rekap_penjualan where id_unit_bisnis="+GlobalVar.idUnitBisnis;
            db.getRecords(SQL);
        ...
        protected void onPostExecute(Integer result) {
            ...
            for (int i=0; i<=GlobalVar.pembeli.size()-1; i++) {
                ViewLapJual v=new ViewLapJual(getContext());
