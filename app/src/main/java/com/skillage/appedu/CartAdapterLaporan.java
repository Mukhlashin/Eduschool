...
public class CartAdapterLaporan extends  RecyclerView.Adapter<CartAdapterLaporan.ViewHolder> {
    ...
    public CartAdapterLaporan(Context context, MyClickListener mcl) {
        this.context = context;
        mMyClickListener= mcl;
        String SQL= "Select * from vw_barang_keluar where id_sekolah="+GlobalVar.idSekolah+" and no_faktur='"+GlobalVar.nofaktur+"'";
        db.getRecords(SQL);
    }
