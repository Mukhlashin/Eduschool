...
public class JadwalSiswaFragment extends Fragment {
    ...
    TextView txtTest;
    public JadwalSiswaFragment() {

    }

    public static JadwalSiswaFragment newInstance(String param1, String param2) {
        JadwalSiswaFragment fragment = new JadwalSiswaFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        GlobalVar.jadwalkuliah.getRecords("SELECT  * from vw_jadwal where id_sekolah="+GlobalVar.idSekolah+" and nama_kelas='"+ GlobalVar.namaKelas +"'");
