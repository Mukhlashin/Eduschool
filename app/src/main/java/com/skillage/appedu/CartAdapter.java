...
public class CartAdapter extends  RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public CartAdapter(Context context, MyClickListener mcl) {
        this.context = context;
        mMyClickListener= mcl;
        String SQL= "Select * from vw_barang_keluar where userid='"+GlobalVar.userID+"' and status='DALAM KERANJANG'";
        db.getRecords(SQL);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                holder.txtQty.setTag(qty);
                double total = qty * Double.parseDouble(holder.txtHarga.getTag().toString());
                DBAndroid db=new DBAndroid();
                db.execute("Update kop_barang_keluar set qty="+qty+" where userid='"+GlobalVar.userID+"' and status='DALAM KERANJANG' and id_barang="+holder.txtNama.getTag());
                if (mMyClickListener != null) mMyClickListener.onItemClick("update");
            }
        });
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DBAndroid db=new DBAndroid();
                db.execute("delete from kop_barang_keluar where userid='"+GlobalVar.userID+"' and status='DALAM KERANJANG' and id_barang="+holder.txtNama.getTag());
                if (mMyClickListener != null) mMyClickListener.onItemClick("delete");
            }
        });
